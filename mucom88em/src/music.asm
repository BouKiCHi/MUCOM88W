...
PLSET2:
	LD	E,3AH ; 0011 1010
	CALL	PSGOUT_BASE		;  TimerB Enable AND Load
...
STTMB2:
	...
	LD D,27H
	LD E,78H
	CALL PSGOUT_BASE     ;  Timer-B OFF
	LD E,7AH
	CALL PSGOUT_BASE     ;  Timer-B ON
...
ADPCM_WORKADR: DW ADPCM_WORK1

ADPCM_WORK1:
STTADR_1: DW      0 ; 0
ENDADR_1: DW      0 ; 2
DELT_N_1:	DW	0	; 4
PCMNUM_1:	DB	0   ; 6 おそらく未使用

ADPCM_WORK2:
STTADR_2: DW      0
ENDADR_2: DW      0
DELT_N_2:	DW	0	; ｻｲｾｲ ﾚｰﾄ
PCMNUM_2:	DB	0 

STTADR_OFS: EQU STTADR_1 - ADPCM_WORK1
ENDADR_OFS: EQU ENDADR_1 - ADPCM_WORK1
DELT_N_OFS: EQU DELT_N_1 - ADPCM_WORK1
PCMNUM_OFS: EQU PCMNUM_1 - ADPCM_WORK1
